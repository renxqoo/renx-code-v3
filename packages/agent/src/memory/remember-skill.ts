/**
 * /remember skill — memory review and reorganization.
 *
 * 1:1 replicate of claude-code-source/src/skills/bundled/remember.ts.
 *
 * Reviews the user's memory landscape and produces a clear report
 * of proposed changes. Does NOT apply changes — presents proposals
 * for user approval.
 */

export const REMEMBER_SKILL_NAME = "remember";
...
/**
 * Build the /remember skill prompt.
 * Optionally appends additional context from the user's command args.
 */
export function buildRememberPrompt(additionalContext?: string): string {
