 ...
 *
 * 1:1 replicate of claude-code-source/src/services/autoDream/consolidationPrompt.ts.
 */

import { ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES } from "../memdir/entrypoint";
import { DIR_EXISTS_GUIDANCE } from "./builder";
