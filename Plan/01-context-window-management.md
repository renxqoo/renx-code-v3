...
`D:\work\renx-code-v3\Plan\01-context-window-management.md` 之前并不完善，且不足以指导后续实现。它的问题不只是“缺少几个功能点”，而是整体设计粒度、运行时接入点、状态持久化要求、压缩恢复链路、模型契约扩展都没有覆盖到位。

本次文档重构的目标不是写一个“上下文超限时做摘要”的简单方案，而是形成一套可直接指导实现的技术说明文档，要求覆盖 `D:\work\claude-code-source` 中与上下文管理相关的核心能力，并且与 `D:\work\renx-code-v3` 当前实际代码结构对齐。
...
- `D:\work\claude-code-source\docs\query-loop-overview.md`
- `D:\work\claude-code-source\docs\steps\step-01-02-context-budget.md`
- `D:\work\claude-code-source\docs\steps\step-03-05-compression-pipeline.md`
- `D:\work\claude-code-source\docs\steps\step-06-autocompact.md`
- `D:\work\claude-code-source\docs\steps\step-10-error-recovery.md`
- `D:\work\claude-code-source\docs\steps\step-11-12-hooks-budget.md`
- `D:\work\claude-code-source\src\query.ts`
- `D:\work\claude-code-source\src\services\compact\autoCompact.ts`
- `D:\work\claude-code-source\src\services\compact\compact.ts`
- `D:\work\claude-code-source\src\services\compact\microCompact.ts`
- `D:\work\claude-code-source\src\services\compact\grouping.ts`
- `D:\work\claude-code-source\src\services\compact\prompt.ts`
- `D:\work\claude-code-source\src\services\compact\sessionMemoryCompact.ts`
- `D:\work\claude-code-source\src\services\compact\postCompactCleanup.ts`
- `D:\work\claude-code-source\src\utils\tokens.ts`
- `D:\work\claude-code-source\src\utils\messages.ts`
- `D:\work\claude-code-source\src\utils\toolResultStorage.ts`
- `D:\work\claude-code-source\src\utils\forkedAgent.ts`
- `D:\work\claude-code-source\src\types\logs.ts`
...
- `D:\work\renx-code-v3\packages\model\src\types.ts`
- `D:\work\renx-code-v3\packages\model\src\errors.ts`
...
- `D:\work\renx-code-v3\Plan\01-context-window-management.md`
- `D:\work\renx-code-v3\Plan\context-window-management\01-source-parity-and-target-architecture.md`
- `D:\work\renx-code-v3\Plan\context-window-management\02-token-accounting-thresholds-and-api-view.md`
- `D:\work\renx-code-v3\Plan\context-window-management\03-message-model-boundaries-and-persistence.md`
- `D:\work\renx-code-v3\Plan\context-window-management\04-compaction-pipeline-and-strategy-details.md`
- `D:\work\renx-code-v3\Plan\context-window-management\05-recovery-rehydration-and-forked-agent-cache.md`
- `D:\work\renx-code-v3\Plan\context-window-management\06-runtime-integration-model-contracts-and-test-plan.md`
- `D:\work\renx-code-v3\Plan\context-window-management\07-source-function-parity-matrix.md`
- `D:\work\renx-code-v3\Plan\context-window-management\08-default-config-sequences-and-acceptance-appendix.md`
- `D:\work\renx-code-v3\Plan\context-window-management\09-end-to-end-flowchart-and-decision-tree.md`
